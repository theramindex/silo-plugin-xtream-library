...
function renderGuidePage() {
  ...
  byId("view").innerHTML = '<div class="guide-page"><div class="guide-commandbar"><div class="guide-commandbar-title"><strong>TV Guide</strong>' + guideFreshnessHTML() + "</div><div class=\"guide-tools\">" + renderGuideCategoryPicker(categories) + "<label class=\"guide-search-field\"><span>" + icon("search") + "</span><input id=\"guide-search\" class=\"search\" placeholder=\"Search programs or channels\" value=\"" + escapeHTML(state.query) + "\"></label></div></div><div id=\"guide-scroll\" class=\"guide-scroll\"><div class=\"guide-timeline\" style=\"" + guideTimelineStyle(slots) + "\"><div class=\"time-head\"><span>Today</span>" + slots.map(function(slot) { return "<span>" + escapeHTML(timeLabel(slot)) + "</span>"; }).join("") + '</div><div id="epg" class="guide-window-spacer" style="height:0px"><div class="guide-window" style="transform:translateY(0px)"></div></div></div></div></div>';
